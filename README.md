# INFORMATION RETRIEVAL USING BOOLEAN MODE

## Aim

To find the ranking of web documents using Boolean Model
...
we get a boolean representation of the terms present in the documents in the form of lists

## step 5:

represent the query in the form of boolean vector

## step 6:

Make the prediction regarding which document is related to the given query by performing the boolean operations

## step 7:

Print the rank of document in output.txt
...
def query_Vector(query):
 ...
 def main():
    documents = pandas.read_csv('documents.csv',encoding= 'unicode_escape')
